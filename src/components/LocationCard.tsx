...
type LocationCardProps={location:Location;onOpen:()=>void;onDelete:()=>void;dragging?:boolean;onPointerDown?:(event:React.PointerEvent<HTMLElement>)=>void;onPointerMove?:(event:React.PointerEvent<HTMLElement>)=>void;onPointerUp?:(event:React.PointerEvent<HTMLElement>)=>void;onPointerCancel?:(event:React.PointerEvent<HTMLElement>)=>void}

export function LocationCard({location,onOpen,onDelete,dragging=false,onPointerDown,onPointerMove,onPointerUp,onPointerCancel}:LocationCardProps){
