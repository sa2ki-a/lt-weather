...
export function AddLocationPage({ onBack, onSave }: { onBack: () => void; onSave: (location: Location) => void }) {
  ...
  const selectResult = (result: GeocodingResult) => { setSelected(result); setSelectedName(result.name) }
  const useCurrent = () => {
